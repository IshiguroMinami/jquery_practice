...
$(function () {
  $(".btn__submit").on("click", function () {
    ...
    console.log($("#account__name").val()); console.log("\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9"); console.log($("#email").val()); console.log("\u30d1\u30b9\u30ef\u30fc\u30c9"); console.log($("#password").val()); console.log("\u78ba\u8a8d\u7528\u30d1\u30b9\u30ef\u30fc\u30c9"); console.log($("#duplication__password").val()); console.log("\u4f4f\u6240"); console.log($("#address").val()); console.log("\u96fb\u8a71\u756a\u53f7"); console.log($("#tel").val()); console.log("\u8cfc\u8aad\u60c5\u5831"); $('[name="subscription"]:checked').each(function () { console.log($(this).val()) })
  })
});